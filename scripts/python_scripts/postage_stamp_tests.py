...
from chrysomallos import CreateDwarfInjectionCatalog, mstar_from_absmag, sb_mv_to_rh
...
if __name__ == "__main__":
    ...
    bands = ["g"]
    for band in bands:
        dataid = {"band": band, "skymap": "hsc_rings_v1", "tract": 9615, "patch": 5}
        image_dict = {}
    ...
    display0.mtv(
        image_dict["g"].image[
            minx + x_cen - 300 : minx + x_cen + 300, y_cen - 300 : y_cen + 300
        ]
    )
    ...
    plt.tight_layout()
    plt.savefig(f"./sb_rh_test_{dist}_mpc_2.png")
