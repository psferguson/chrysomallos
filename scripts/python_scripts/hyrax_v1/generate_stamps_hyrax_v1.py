...
def run_single_config(args):
    ...
    config["stamp"]["title_format"] = f"hsc_pdr3_stamp_v{version}"
...
if __name__ == "__main__":
    ...
    config_dict = "./hyrax_v1_config.yaml"
    
    manifest_frame_path = main_dir + 'data/run_v1_stamp_centers.csv'
    manifest_frame = pd.read_csv(manifest_frame_path)
    manifest_frame = manifest_frame.sample(n=25000, replace=False, random_state=69420)
